  ...
  return (
    <FiltroContainer>
      ...
      <div className='checkContainer'>
        <p>LINHA</p>
        <div className='checkbox'><input  onChange={(e) => {setPremium(e.target.checked)}}  value='Premium' type='checkbox' id='pre'/> <label className="linha1" htmlFor='pre' >PREMIUM</label></div> 
        <div className='checkbox'><input  onChange={(e) => {setBagaceira(e.target.checked)}}  value="Bagaceira" type='checkbox' id='peb'/> <label className="linha2" htmlFor='peb' >BAGACEIRA</label></div>
        <div className='checkbox'><input  onChange={(e) => {setJunina(e.target.checked)}}  value="Junina" type='checkbox' id='jun'/> <label className="linha3" htmlFor='jun' >JUNINA</label></div>
      </div>
      <div>
        <p>ORDENAR</p>
        <select className='select' onChange={(e) => {props.setOrdenar(e.target.value)}}>
          <option value="-">-</option>
      ...
      <div>
        <p>VALOR</p>
      <input placeholder='Min' type='number' onChange={(e) =>{setMin(Number(e.target.value))}} />
      <input placeholder='Max' type='number' onChange={(e) =>{setMax(Number(e.target.value))}}/>
      </div>
