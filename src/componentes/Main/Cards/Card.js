  ...
  return (
    <CardsContainer>
      {config.estrelas
        ...
        .filter((estrela) => {
          return (
            estrela.valor >= props.precos.min &&
            estrela.valor <= props.precos.max
          );
        })
        .filter((estrela) => {
          if (
          ...
          if (props.linhas[0].bool && props.linhas[1].bool) {
            return (
              estrela.linha === props.linhas[0].nome ||
              estrela.linha === props.linhas[1].nome
            );
          }
          if (props.linhas[0].bool && props.linhas[2].bool) {
            return (
              estrela.linha === props.linhas[0].nome ||
              estrela.linha === props.linhas[2].nome
            );
          }
            ...
            <Cards key={estrela.id}>
              <div>
                ...
                <p
                  ...
                  style={{
                    backgroundColor: `${
                      estrela.linha === "Premium"
                        ? "#ea7ffa"
                        : estrela.linha === "Bagaceira"
                        ? "#30d7fc"
                        : "#ff9cf2"
                    }`,
                  }}
